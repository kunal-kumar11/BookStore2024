  ...
  return (
    <div className="h-auto lg:h-[100%] flex flex-col p-3 items-center justify-between">
      <div className="flex flex-col items-center w-full">
        <img src="/avatar.png" alt="profile" className="h-[10vh] rounded-full object-cover" />
      ...
      <div className="w-full flex-col items-center justify-center mt-8">
        <button
          onClick={() => {
          ...
          className="flex items-center text-zinc-100 font-semibold w-full py-2 mt-4 text-center hover:bg-zinc-900 rounded transition-all duration-300"
        >
